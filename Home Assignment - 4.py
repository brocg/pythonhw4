...
# l[2][2] = 'goodbye' #list items are indexed, so just manually replacing. Another approach could be looping through list
# print(l)
...
# def stringBits(str):
#   return print(str[::2]) #slice notation in python has the syntax [<start>:<stop>:<step>], [::2] takes in the full string printing every other character
...
#   if n == 15 or n == 16:
#     return n
#   elif n == 13 or n == 14 or n == 17 or n == 18 or n == 19:
#     return 0
#   else:
#    return n

# print(no_teen_sum(15, 2, 3)) #→ 6
